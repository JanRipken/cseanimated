...
class whatsinfo(Scene):
    def construct(self):
        ...
        title = Tex("Was ist Informatik").scale(1.5)

        definition_1 = Tex("Definition 1:").to_edge(UP)
        definition_2 = Tex("Definition 2:").to_edge(UP)
        definition1 = Tex("Informatik ist die Wissenschaft von der systematischen Verarbeitung von Informationen, besonders der automatischen, mit Hilfe von Computern.",organize_left_to_right=True).scale(0.8)
        definition2 = Tex("Informatik ist die Wissenschaft, Technik und Anwendung der maschinellen Verarbeitung und Übermittlung von Informationen",organize_left_to_right=True).scale(0.8)
        ...
        techinf = Tex("Technische Informatik:",color=ORANGE)
        techinf_info = Tex("Befasst sich mit der inneren Struktur, dem Bau von Computern und allen damit zusammenhängenden technischen Fragen")
        ...
        prakinf = Tex("Praktische Informatik:",color=ORANGE)
        prakinf_info = Tex("Umfasst die Prinzipien und Techniken der Programmierung")
        ...
        angeinf = Tex("Angewandte Informatik:",color=ORANGE)
        angeinf_info = Tex("Bildet die Brücke zwischen Methoden der Informatik und Anwendungsproblemen")
        ...
        theoinf = Tex("Theoretische Informatik:",color=ORANGE)
        theoinf_info = Tex("Entwickelt Mathematische Modelle von Computern und Hilfsmittel zu ihrer präziesen Beschreibung")
